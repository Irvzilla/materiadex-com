  ...
  return (
    <Layout path={props.location.pathname}>
      ...
      <SEO
        ...
        description={'A Multi-Standard Decentralized Exchange '}
      />
      <StyledBody>
        <StyledTitle>
...
const SummarySection = props => {
  return (
    <StyledBodySubText>
      <h1>
      By implementing new technology, <b>Materia</b> enables new possibilites with <b>Batchswapping</b> transactions and seemless interaction between various Erc token standards.
          </h1>
      <p>
